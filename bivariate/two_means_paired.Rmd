...
[PDF file location: http://www.murraylax.org/rtutorials/two_means_paired.pdf](http://www.murraylax.org/rtutorials/two_means_paired.pdf)

[HTML file location: http://www.murraylax.org/rtutorials/two_means_paired.html](http://www.murraylax.org/rtutorials/two_means_paired.html)
...
The code below downloads the file then reads it into an R data frame that we name `fatalities`.

```{r}
fatalities <- read.csv(url("http://murraylax.org/datasets/vehiclefatalities.csv"));
```
