...
[PDF file location: http://www.murraylax.org/rtutorials/one_sample_median.pdf](http://www.murraylax.org/rtutorials/one_sample_median.pdf)

[HTML file location: http://www.murraylax.org/rtutorials/one_sample_median.html](http://www.murraylax.org/rtutorials/one_sample_median.html)
...
The code below downloads the data set and assigns the data set to a variable we call `kidsdata`.
